...
features = []
for row in csv.reader(open('/Users/daggubatisirichandana/PycharmProjects/MLTechniques/_VisualRecognition/Assignment2/cifar_surf_features.csv', 'r'), delimiter=','):
